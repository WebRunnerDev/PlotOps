...
| GitHub collaborator auto-suggest     | On repo connect, list GH collaborators and offer “Add to Team”. Plan: [`docs/deferred/wave-2-team-invites.md`](deferred/wave-2-team-invites.md) §2.3.                   |
| Custom SMTP / real invite emails     | Invite model stays email-addressed; wire Resend (or similar) when free-tier mail is not enough. Plan: [`wave-2-team-invites.md`](deferred/wave-2-team-invites.md) §2.2. |
