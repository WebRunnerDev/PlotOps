...
| Team & permissions (`project_members`, roles, invites) | ✅ Done (Project-boundary MVP); 🟡 Team above Project — domain locked ADR 0017; schema+RLS #155 done (local); Team settings #157 + invite redeem #158 done (local); UI gating #160 done; Home Teams shell #156 + optional All projects flat list #174 done (local); create Project under Team (GH connect + name-only #175) done (local); Git/CI empty-state gate #176 done (local); connect-later #177 open; lifecycle remainder #159 (delete empty Team) open |
...
| Item                                 | Notes                                                                                                                                                |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| Projects without GitHub              | Slice 1 create UX (#175) + Git/CI empty-state gate (#176) done (local). Connect-later attach repo #177 still open before clearing this Deferred row. |
