...
| Kanban board                                           | ✅ Done (custom columns, labels/priority/deadline; board filters; comments; soft-archive + board archive dialog; header **+ New Task** CTA → first-column create #173; Make skin pass on board/cards/drawer — ADR 0007; DnD polish deferred; Subtask visibility toggle + Parent progress badge #199)                                                                                                                                                                                                                |
