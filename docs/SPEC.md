...
| Kanban board                                           | ✅ Done (custom columns, labels/priority/deadline; board filters; comments; soft-archive + board archive dialog; header **+ New Task** CTA → first-column create #173; Make skin pass on board/cards/drawer — ADR 0007; DnD polish deferred)                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| Command palette                                        | ✅ Done (Ctrl/Cmd+K + TopBar; rules seam; search Tasks + Include archived; Search Members → Team settings; Create Task/bug/feature; navigate Board/Backlog/CI/CD/Settings; Switch Project → last Board; Toggle theme — #21–#26, #170–#172)                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| Team & permissions (`project_members`, roles, invites) | ✅ Done (Project-boundary MVP); 🟡 Team above Project — domain locked ADR 0017; schema+RLS #155 done (local); Team settings #157 + invite redeem #158 done (local); UI gating #160 done; Home Teams shell #156 + optional All projects flat list #174 done (local); create Project under Team (GH connect + name-only #175) done (local); Git/CI empty-state gate #176 done (local); connect-later attach repo #177 done (local); open Team invite links ADR 0019 / wave 2.1 done (local); Resend `send-team-invite` EF / wave 2.2 done (local; secrets optional); GitHub collaborator auto-suggest / wave 2.3 done (local); lifecycle remainder #159 (delete empty Team) open |
