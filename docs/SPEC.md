...
| Git integration (PR, diff, branches)                          | ✅ Done (Git tab; branch generate/link/skip; link PR; in-app code diff; Open PR + Merge from task panel — ADR 0022; PR check runs rollup in drawer — ADR 0025; Approve/request-review still deferred)                                                                                                                                                                                                                                                                                                               |
