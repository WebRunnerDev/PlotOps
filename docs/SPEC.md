...
| Team & permissions (`project_members`, roles, invites) | ✅ Done (Project-boundary MVP); 🟡 Team above Project — domain locked ADR 0017; schema+RLS #155 done (local); Team settings #157 + invite redeem #158 done (local); UI gating #160 done; Home Teams shell #156 + optional All projects flat list #174 done (local); create Project under Team (GH connect + name-only #175) done (local); Git/CI gate #176 + connect-later #177 open; lifecycle remainder #159 (delete empty Team) open |
...
| Item                                 | Notes                                                                                                                                                    |
| ------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Projects without GitHub              | Slice 1 create UX done (#175): Owner/Admin can create name-only Project (null `github_*`). Git/CI empty-state gate #176 + connect-later #177 still open. |
