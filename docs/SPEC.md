...
| **Deferred**    | Palette/invite expansions, in-app PR write actions, and other parked items — see [Deferred / later](#deferred--later) and [`docs/deferred/`](deferred/README.md).                                                                                                                                                                                                                                                                                                                                       |
