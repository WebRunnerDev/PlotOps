...
| Command palette                                        | ✅ Done (Ctrl/Cmd+K + TopBar; rules seam; search Tasks + Include archived; Create Task/bug/feature; navigate Board/Backlog/CI/CD/Settings; Switch Project → last Board; Toggle theme — #21–#26, #170, #171)                                                                                                                         |
