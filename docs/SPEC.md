...
| Team & permissions (`project_members`, roles, invites) | ✅ Done (Project-boundary MVP); 🟡 Team above Project — domain locked ADR 0017; schema+RLS #155 done (local); Team settings #157 + invite redeem #158 done (local); UI gating via `useTeamAccess` #160 done (local); Home/lifecycle tickets open |
...
7. **UI gating** — `useTeamAccess` for Board/Git/settings controls (RLS remains source of truth). ✅ (#160)
