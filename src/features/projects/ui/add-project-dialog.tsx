            ...
            <DialogContent className="flex max-h-[min(80vh,640px)] flex-col gap-0 overflow-hidden p-0 sm:max-w-xl">
                ...
                >
                    {(
                        [
                            ...
                            ["name-only", t("createProjectModeNameOnly")],
                        ] as const
                    ).map(([value, label]) => (
                        <Button
                ...
                {mode === "github" ? (
                    ...
                    <form
                        ...
                        onSubmit={(event) => void handleNameOnlySubmit(event)}
                    >
                        <div className="flex flex-col gap-2">
                            ...
                            <Input
                                ...
                                onChange={(event) => {
                                    ...
                                    setName(nextName);
                                    if (!slugTouched) {
                                        setSlug(suggestProjectSlug(nextName));
                                    }
                                }}
                        ...
                        <DialogFooter className="px-0 sm:justify-end">
                            ...
                            <Button disabled={!canSubmitNameOnly} type="submit">
                                {createProject.isPending ? (
