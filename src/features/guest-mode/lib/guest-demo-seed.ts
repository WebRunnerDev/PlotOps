...
export const GUEST_DEMO_SEED: GuestSandbox = {
    ...
    notifications: [
        ...
        },
        {
            ...
            id: "d0000000-0000-4000-8000-000000000305",
            kind: "comment",
            metadata: {
                commentId: "e0000000-0000-4000-8000-000000000401",
                source: "app",
            },
            projectId: PROJ_GIT_ID,
            readAt: null,
        ...
        },
        {
            ...
            id: "d0000000-0000-4000-8000-000000000306",
            kind: "title_change",
            metadata: {
                from: "Wire guest CTA",
                source: "app",
                to: "Wire guest sign-in CTA",
            },
            projectId: PROJ_GIT_ID,
            readAt: null,
            taskId: T01,
        ...
        },
        {
            ...
            id: "d0000000-0000-4000-8000-000000000307",
        ...
        },
        {
            ...
            id: "d0000000-0000-4000-8000-000000000308",
            kind: "labels_change",
            metadata: {
                source: "app",
            },
            ...
            taskId: T03,
            taskKey: "TASK-3",
            taskTitle: "Seed demo kanban cards",
        },
        {
            createdAt: "2026-08-06T14:00:00.000Z",
            id: "d0000000-0000-4000-8000-000000000309",
            ...
            taskId: T05,
            taskKey: "TASK-5",
            taskTitle: "Document local Guest Mode",
        },
        {
            createdAt: "2026-08-06T15:00:00.000Z",
            id: "d0000000-0000-4000-8000-000000000310",
            kind: "sprint_change",
            metadata: {
                source: "app",
            },
            ...
            taskId: T04,
            taskKey: "FEAT-4",
            taskTitle: "Guest Session detection",
        },
    ],
    projects: [
        {
