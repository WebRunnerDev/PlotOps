...
function DockDropdownItem({
    ...
    return (
        <DockItem active={active} aria-label={label}>
            <DropdownMenu>
                <DropdownMenuTrigger
                    className="flex size-full cursor-pointer items-center justify-center rounded-full border-0 bg-transparent p-0 text-foreground outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                >
                    {children}
                </DropdownMenuTrigger>
                <DropdownMenuContent align="center" className="w-56" side="top" sideOffset={10}>
                    {menu}
                </DropdownMenuContent>
            </DropdownMenu>
        </DockItem>
...
function DockAccountItem() {
    ...
    return (
        <>
            <DropdownMenu>
                <DropdownMenuTrigger
                    className="flex h-11 max-w-48 cursor-pointer items-center gap-2 rounded-full border-0 bg-transparent px-2 text-foreground outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                >
                    <Avatar size="sm">
                        {avatarUrl ? (
                ...
                <DropdownMenuContent align="center" className="w-fit" side="top" sideOffset={10}>
                    <DropdownMenuItem
