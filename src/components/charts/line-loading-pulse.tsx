...
export type LineLoadingPulseMode = "enter" | "exit" | "loop";

export interface LineLoadingPulseStrokeProperties {
...
export function LineLoadingPulseStroke({
    ...
    strokeOpacity = 0.5,
    strokeWidth = 2.5,
}: LineLoadingPulseStrokeProperties) {
    ...
    const { clipWidth, clipX } = useGrowExitClip(
        innerWidth,
        mode,
        loopEpoch,
        onCycleComplete
