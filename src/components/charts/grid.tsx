...
export function Grid({
    ...
    highlightRowStroke = chartCssVariables.foregroundMuted,
    ...
    horizontal = true,
    loadingStroke,
    numTicksColumns: numberTicksColumns = 10,
    numTicksRows: numberTicksRows = 5,
    rowTickValues,
    shimmer = false,
    ...
    const gridStroke =
        isLoadingGridChromePhase(chartPhase) && loadingStroke != undefined
            ? loadingStroke
            : stroke;
    ...
    const columnTickValuesResolved =
        ...
        hideVerticalEdgeLines
            ? (() => {
                  const ticks = columnScale.ticks?.(numberTicksColumns) ?? [];
        ...
        <g className="chart-grid">
            ...
            {horizontal && (
                <g mask={horizontalFadeMask}>
                    <GridRows
                        numTicks={
                            rowTickValuesResolved ? undefined : numberTicksRows
                        }
                        scale={yScale}
                        stroke={gridStroke}
