...
export interface TooltipIndicatorProperties {
    ...
    fadeEdges?: boolean | IndicatorFadeEdges;
...
export function TooltipIndicator(properties: TooltipIndicatorProperties) {
    if (!properties.visible) {
        return null;
    }
    return <TooltipIndicatorInner {...properties} />;
}
...
function TooltipIndicatorInner({
    animate = true,
    colorEdge = chartCssVariables.crosshair,
    colorMid = chartCssVariables.crosshair,
    columnWidth,
    fadeEdges = "both",
    fadeLength = 10,
